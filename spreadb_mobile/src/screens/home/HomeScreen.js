        ...
        >
          ...
          {isInfluencer && (
            <TouchableOpacity
              ...
              activeOpacity={0.8}
            >
              <Ionicons name="color-wand-outline" size={13} color={COLORS.primary} />
        ...
        <View style={styles.statsRow}>
          {isInfluencer ? (
            <>
              ...
              <StatCard icon="color-wand-outline"   label="Sticks Left"  value={counts.sticks || 0}                        accent="#D97706"          onPress={() => navigation.navigate('Wallet')} />
            </>
          ) : (
            <>
